...
foreach ($data as $k => $v) {
    ...
    if($v['coordonnees']!='') {
        ...
        <div id="t-'.$k.'" class="c-text c-little '.$v['class'].'">
            ...
            <p>Service Framasoft : <span class="h4">'.$v['alt_frama'].'</span><br />';
...
réussite de ce projet ambitieux. Framasoft est une association d'intérêt
 général : un don de 100€ vous reviendra, après défiscalisation, à 34€.</p>
                ...
                <p class="signature text-right small">Campagne commencée le 07/10/2014<br/>Dernière modification le 17/07/2015</p>
            </div>
        </div>
    </div>
