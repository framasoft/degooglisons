        ...
        <div class="row" id="bloc-carte">
            <div class="container ombre">
                <div class="col-md-8 col-md-offset-2 map">
                    <div class="well">
						<img src="img/carte-full.jpg" alt="Nous sommes en 2014 après Jésus-Christ. Toute la toile est occupée par des services centralisés... Toute ? Non ! Une communauté peuplée d'irréductibles libristes résiste encore et toujours à l'envahisseur. Et la vie n'est pas facile pour les garnisons des camps retranchés de Fermetum, Centralisum, Espionnum et Privatum…" style="width:100%" id="carte" usemap="#cartemap" />
...
empêchant, par exemple, de migrer vos données ailleurs facilement.</p>
...
sociétés publicitaires. De plus, la plupart sont basées aux États-Unis et
...
contre le terrorisme, les états sont aujourd'hui capables d'obtenir bien plus
