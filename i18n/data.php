...
$d[$k]['altOff'] = $d[$k]['S'];
$d[$k]['pos']    = '';
$d[$k]['FDate']  = '<a href="http://framablog.org/2016/05/28/minetest-piochez-en-lberte/">2016</a>';
$d[$k]['cat']    = 'hobbies';
...
$potion  = ['avaaz','evernote','gagenda','ggroups','skype','youtube','1000minds','gforms','transifex'];
$fight   = ['bubblus','doodle','dropbox','gdocs','greader','gspreadsheet',
            'pixlr','facebook','pocket','bitly','github','gbooks','gmaps',
            'gsearch','imgur','kongregate','loomio','minecraft','padlet',
            'pastebin','slack','trello','wetransfer'];
